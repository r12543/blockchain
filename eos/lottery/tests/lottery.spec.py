...
import sys
sys.path.append("/home/rajat.choudhary/work/blockchain_local/eos/eosfactory/pyteos")
print(sys.path)
...
class Test1(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        CONTRACT_NAME = "/home/rajat.choudhary/work/blockchain/eos/lottery/contracts/lottery"
        testnet = node.reset()
        ...
        # cprint(""" Not Building the contract abi/wast due to jankyness - use compile.sh in the root dir for now """, 'magenta')
